...
{
    public abstract class LibraryManagementProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LibraryManagementProjectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LibraryManagementProjectWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LibraryManagementProjectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LibraryManagementProjectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LibraryManagementProjectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LibraryManagementProjectDbContext, Task<T>> func)
        {
            T result;
